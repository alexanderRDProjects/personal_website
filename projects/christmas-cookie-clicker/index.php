...
<p>For the Christmas of 2015 for a class project I formed a group and created cookie clicker using pygame this involved creating graphics for the game learning how to use pygame game and coding the underlining logic of the game this program was completed on time for christmas</p>
</div>
...
$commentsql ="SELECT userid,comment FROM usercomments WHERE itemid = '5'; ";
