...
">
<h1> Christmas Hackathon</h1>
<p>so for christmas 2016 I attended my local hackathon where I put in a team we had the vague theme of christmas and decided to a christmas themed version of space invaders using pygame and python. This was my first hackathon so it was a learning curve despite the lack of a coherant end solution though it partaily worked </p>
</div>
...
$commentsql ="SELECT userid,comment FROM usercomments WHERE itemid = '3'; ";
